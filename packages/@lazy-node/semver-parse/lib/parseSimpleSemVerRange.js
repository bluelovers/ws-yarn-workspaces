...
function parseSimpleSemVerRange(str) {
    ...
    if ((0, checker_1.isSemverWildcard)(str)) {
        arr.push(new SimpleSemVer_1.SimpleSemVer({
            semver: str,
        }));
        return arr;
    }
    ...
    let m;
    const_1.reSemverRange.lastIndex = 0;
    ...
    while ((m = const_1.reSemverRange.exec(str)) !== null) {
        ...
        if (!(0, checker_1.isValidVersion)(str, major, minor, patch, release, build)) {
            // 無效版本，返回空陣列
            // Invalid version, return empty array
            return [];
        }
        ...
        (0, pruned_1.normalizeSemVerObjectInput)(obj, {
            init: true,
        });
