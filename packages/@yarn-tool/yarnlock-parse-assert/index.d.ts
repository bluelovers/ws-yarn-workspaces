import { EnumDetectYarnLock, IYarnLockDataRecord, IYarnLockDataRowBase, IYarnLockDataRowV1, IYarnLockDataRowV2, IYarnLockParsed, IYarnLockParsedLoose, IYarnLockParsedV1, IYarnLockParsedV2 } from '@yarn-tool/yarnlock-types';
export declare function isYarnLockParsed(parsedObject: IYarnLockParsed): parsedObject is IYarnLockParsed;
export declare function assertYarnLockParsed(parsedObject: IYarnLockParsed | IYarnLockParsedLoose): asserts parsedObject is IYarnLockParsed;
