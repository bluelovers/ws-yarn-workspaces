 ...
 */
export function isHostedGitResult(npaResult: IResultAll): npaResult is HostedGitResult
{
 ...
 */
export function isNameSameAsRaw<T extends IResult>(result: IResult)
{
 ...
 */
export function isRawSpecIsEmpty(result: IResult)
{
	return result.rawSpec?.trim() === ''
}
 ...
 */
export function isInputSpecIsStar(result: IResult)
{
	const raw = result.raw.trim();
 ...
 */
export function isInputSpecIsEmpty(result: IResult)
{
