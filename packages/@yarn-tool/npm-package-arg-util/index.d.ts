 ...
 * @internal
 */
export declare function _npa2Core<T extends IResult>(arg: string, options?: IOptionsNpaUtil): T;
/**
 ...
 * });
 */
export declare function npa2<T extends IResult>(arg: string, where?: string | IOptionsNpaUtil, options?: IOptionsNpaUtil): T;
/**
 ...
 */
export declare function npa<T extends IResult>(arg: string, where?: string | IOptionsNpaUtil, options?: IOptionsNpaUtil): T;
/**
 ...
 */
export declare function handleOptionsNpaUtil(options?: IOptionsNpaUtil, optOrWhere?: IOptionsNpaBase | string): IOptionsNpaUtil;
/**
 ...
 */
export declare function npaTry<T extends IResult>(arg: string, where?: string | IOptionsNpaUtil, options?: IOptionsNpaUtil): T;
/**
 ...
 * @returns {T | undefined} 解析結果，如果解析失敗則返回 undefined
 */
export declare function npaTry2<T extends IResult>(arg: string, where?: string | IOptionsNpaUtil, options?: IOptionsNpaUtil): T;
export default npa;
