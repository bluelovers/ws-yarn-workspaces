...
export declare const defaultCopyStaticFilesRootOnly: IStaticFilesMapArray<"lerna.json.tpl" | "pnpm-workspace.yaml.tpl" | "tsconfig.json" | ".eslintrc.json" | ".yarnrc.yml.tpl">;
