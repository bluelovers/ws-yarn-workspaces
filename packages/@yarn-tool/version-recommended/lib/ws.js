...
function nextVersionRecommendedByWorkspacesProject(oldVersion, wsProject, options) {
    return (0, nextVersionRecommended_1.nextVersionRecommended)(oldVersion, options, wsProject);
}
