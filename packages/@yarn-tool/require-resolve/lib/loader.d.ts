 ...
 * ```
 */
export declare function requireExtra<T = unknown>(name: string, options?: IOptionsRequireResolve): T;
/**
 * 解析並動態導入模組
 ...
 * ```
 */
export declare function importExtra<T = unknown>(name: string, options?: IOptionsRequireResolve): Promise<T>;
/**
 * 嘗試載入模組，失敗時返回 null
 ...
 * ```
 */
export declare function tryRequireExtra<T = unknown>(name: string, options?: IOptionsRequireResolve): T | null;
/**
 ...
 * ```
 */
export declare function tryImportExtra<T = unknown>(name: string, options?: IOptionsRequireResolve): Promise<T | null>;
