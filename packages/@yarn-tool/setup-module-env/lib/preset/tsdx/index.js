...
function updatePackageJson(pkg) {
    ...
    (_d = (_q = pkg.scripts)["build:dts:bundle"]) !== null && _d !== void 0 ? _d : (_q["build:dts:bundle"] = "ynpx dts-bundle-generator -o ./dist/index.d.ts ./src/index.ts --no-banner & echo build:dts");
