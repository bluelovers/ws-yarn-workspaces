...
exports._handleDefaultKey = _handleDefaultKey;
...
function handlePackageBins(bins, resolveFn) {
    ...
    return Object.entries(bins)
        ...
        const normalizedBin = (0, upath2_1.normalize)(bin);
        if (!(0, upath2_1.isAbsolute)(normalizedBin)) {
            // 相對路徑：加上 './' 前綴
 ...
 * ```
 */
function _handleDefaultKey(pkgInfo, defaultKey) {
    // 若未指定 defaultKey，從套件名稱推斷 / Infer defaultKey from package name if not specified
    // 處理 scope 套件：@scope/pkg-name → pkg-name
    if (!(defaultKey === null || defaultKey === void 0 ? void 0 : defaultKey.length) && typeof pkgInfo.name === 'string') {
