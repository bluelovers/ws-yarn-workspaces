...
{
	const pkgInfo = getPackageInfo(options);
 ...
 * @internal
 */
export function _normalizePackageBinsCore(options: IOptions, pkgInfo: IGetPackageInfoResult)
{
 ...
 * @internal
 */
export function _defaultPackageBinCore(options: IOptions, pkgInfo: IGetPackageInfoResult, defaultKey?: string)
{
	...
	defaultKey = _handleDefaultKey(pkgInfo, defaultKey);
 ...
 * ```
 */
export function _findDefaultPackageBinByBins(bins: Record<string, string>, defaultKey?: string)
{
