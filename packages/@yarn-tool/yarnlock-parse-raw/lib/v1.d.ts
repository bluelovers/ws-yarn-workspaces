...
export declare function getYarnLockRawV1Root(input: IYarnLockRawSourceV1): import("@yarn-tool/yarnlock-types").IYarnLockDataRecord<import("@yarn-tool/yarnlock-types").IYarnLockDataRowV1>;
