...
function installDepsFromWorkspaces(packageNames, options = {}) {
    ...
    const others = packageNames
        ...
        if (row) {
            ...
            let bool = true;
            if (options.dev && !((_b = (_a = pkg.devDependencies) === null || _a === void 0 ? void 0 : _a[name]) === null || _b === void 0 ? void 0 : _b.length)) {
                (_c = pkg.devDependencies) !== null && _c !== void 0 ? _c : (pkg.devDependencies = {});
                pkg.devDependencies[name] = semver;
                bool = false;
            }
            if (options.peer && !((_e = (_d = pkg.peerDependencies) === null || _d === void 0 ? void 0 : _d[name]) === null || _e === void 0 ? void 0 : _e.length)) {
                (_f = pkg.peerDependencies) !== null && _f !== void 0 ? _f : (pkg.peerDependencies = {});
                pkg.peerDependencies[name] = semver;
                bool = false;
            }
            if (options.optional && !((_h = (_g = pkg.optionalDependencies) === null || _g === void 0 ? void 0 : _g[name]) === null || _h === void 0 ? void 0 : _h.length)) {
                (_j = pkg.optionalDependencies) !== null && _j !== void 0 ? _j : (pkg.optionalDependencies = {});
                pkg.optionalDependencies[name] = semver;
                bool = false;
            }
            if (bool && !((_l = (_k = pkg.dependencies) === null || _k === void 0 ? void 0 : _k[name]) === null || _l === void 0 ? void 0 : _l.length)) {
