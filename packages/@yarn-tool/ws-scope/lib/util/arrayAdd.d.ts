 ...
 * ```
 */
export declare function arrayAdd(scope: string, value?: string[]): ArrayOperationResult<string>;
/**
 ...
 * ```
 */
export declare function arrayRemove(scope: string, value: string[]): ArrayOperationResult<string>;
export {};
