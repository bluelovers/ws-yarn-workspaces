...
export declare class WorkspacesScope {
    /**
     * Root workspace data containing workspace root path information
     * 根工作區資料，包含工作區根目錄路徑資訊
     *
     * @type {IFindRootReturnType}
     */
    rootData: IFindRootReturnType;
    /**
     * Scope handler for package.json workspaces field
     * package.json workspaces 欄位的範圍處理器
     *
     * @type {ScopeJson<'workspaces'>}
     * @private
     */
    _root_package_json: ScopeJson<'workspaces'>;
    /**
     * Scope handler for lerna.json packages field
     * lerna.json packages 欄位的範圍處理器
     *
     * @type {ScopeJson<'packages'>}
     * @private
     */
    _root_lerna_json: ScopeJson<'packages'>;
    /**
     * Scope handler for pnpm-workspace.yaml packages field
     * pnpm-workspace.yaml packages 欄位的範圍處理器
     *
     * @type {ScopeJson<'packages'>}
     * @private
     */
