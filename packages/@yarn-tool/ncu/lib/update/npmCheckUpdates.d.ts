...
export declare function npmCheckUpdates<C extends IWrapDedupeCache>(cache: Partial<C>, ncuOptions: ITSRequireAtLeastOne<IOptionsNpmCheckUpdates, 'json_old' | 'packageData'>): Promise<Omit<IOptionsNpmCheckUpdates, "packageData" | "json_old"> & import("ts-type/index").ITSRequiredPick<IOptionsNpmCheckUpdates, "json_old"> & import("ts-type/index").ITSPartialPick<IOptionsNpmCheckUpdates, "packageData">>;
