 ...
 */
export const TEST_DATE_INFO: Record<string, { date: Date; options: IVersionStyleOptionsWithDateInfo; quarter: number }> = {
...
export const DATE_TO_VERSION_STYLE_TEST_CASES: Array<{
	...
	{ style: EnumVersionStyle.StandardFullMD, dateInfo: { year: 2026, month: 3, day: 8, dailyIncrement: 1 }, expected: '2026.308.1' },
	...
	{ style: EnumVersionStyle.JetbrainsShort, dateInfo: { year: 2026, month: 1, day: 1, dailyIncrement: 2 }, expected: '261.1.1-2' },
];
...
export const DATE_TO_VERSION_DISABLE_SUFFIX_TEST_CASES: Array<{
	...
	{ style: EnumVersionStyle.JetbrainsShort, dateInfo: { ...TEST_BASE_OPTIONS, disableDailyVersionSuffix: true }, expected: '261.1.1' },
	{ style: EnumVersionStyle.StandardFull, dateInfo: { ...TEST_BASE_OPTIONS, disableDailyVersionSuffix: true }, expected: '2026.1.1' },
	// MD 格式應該忽略 disableDailyVersionSuffix
	{ style: EnumVersionStyle.JetbrainsShortMD, dateInfo: { ...TEST_BASE_OPTIONS, disableDailyVersionSuffix: true }, expected: '261.101.1' },
	{ style: EnumVersionStyle.StandardFullMD, dateInfo: { ...TEST_BASE_OPTIONS, disableDailyVersionSuffix: true }, expected: '2026.101.1' },
];
...
export const PARSE_VERSION_TEST_CASES = [
	...
	{ version: '262.615.1', expected: { year: 2026, month: 6, day: 15, dailyVersion: 1, isJetbrainsShort: true, isMDCombined: true } },
