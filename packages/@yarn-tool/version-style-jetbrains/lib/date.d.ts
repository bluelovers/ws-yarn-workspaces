...
import { IDateInfo, IDateInfoMonthDay, IDateInput, IParseJetbrainsYearResult, IParseMonthDayResult, IVersionStyleOptions } from './types';
 ...
 */
export declare function getDayjsFromInput(date: IDateInput, opts?: IOptionsTzDayjsSafeParse): Dayjs;
/**
 * 從 Date 物件取得日期資訊
