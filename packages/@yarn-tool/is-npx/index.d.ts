 ...
 */
export declare function _isNpx(opts: IOptionsDetectNpx): boolean;
/**
 ...
 */
export declare function _inNpxPath(__dirname: string): boolean;
/**
 * 處理並標準化 NPX 檢測選項
 ...
 */
export declare function handleOptionsDetectNpx(opts: IOptionsDetectNpxInput): IOptionsDetectNpx;
/**
 ...
 */
export declare function isNpx(opts: IOptionsDetectNpxInput): boolean;
/**
 * 預設匯出：isNpx 函式
