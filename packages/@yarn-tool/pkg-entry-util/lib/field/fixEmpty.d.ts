 ...
 */
export declare function isEmptyConfig(value: any[] | object | string | unknown): boolean;
/**
 * 清理空欄位的核心函數
 ...
 */
export declare function _fixEmptyFieldsCore<T extends IPackageJson>(pkg: T, root: string, keys: (keyof T)[]): T;
/**
 ...
 * @returns {T} 清理後的 package.json 物件 / Cleaned package.json object
 */
export declare function fixEmptyFields<T extends IPackageJson>(pkg: T, root: string): T;
